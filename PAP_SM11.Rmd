...
# BACKGROUND: WHY {admiralroche}, AND WHY ADaM TEMPLATES?

## {admiralroche} covers the ~10% of Roche's ADaM standards that {admiral} does not

```{r fig1, echo=FALSE, results="asis", fig.cap="The 80/10/10 split between shared {admiral} code, the sponsor-interpretation slice covered by {admiralroche}, and genuinely study-specific code."}
